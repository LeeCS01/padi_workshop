...
import 'package:sawahcek/screen/usersettings_users.dart';
              ...
              onSelected: (value) {
                ...
                if (value == 'option2') {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => usersettings(id:email,fullname: fullname,username: username,email: email,password: password),// Navigate to SignupAdmin
                    ),
                  );
                }
