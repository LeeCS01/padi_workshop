...
class waterlevelreport extends StatefulWidget {
  @override
  _waterlevelreportState createState() => _waterlevelreportState();
  final String id;
...
class _waterlevelreportState extends State<waterlevelreport> with SingleTickerProviderStateMixin {
  ...
  Future<Null> getData() async {
    final response = await http
        .post(Uri.parse("http://10.131.72.117/sawahcek/getdevice.php"));
  ...
  Future<Null> realtimeupdate() async {
    final response = await http
        .post(Uri.parse("http://10.131.72.117/sawahcek/realtimeupdate.php"));
    if (response.statusCode == 200) {
      print("done update");
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () {
                                ...
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => waterlevelreport(id: widget.id,)),
                                );
                              },
                            ),
                            if (selectedDevice != null)
  ...
  Future<void> sendDataToDB() async {
    ...
    final response = await http.post(
      Uri.parse("http://10.131.72.117/sawahcek/insertcase.php"),
      body: postData,
    );
