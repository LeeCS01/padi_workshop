...
class _DetailAdminReportCentreState extends State<DetailAdminReportCentre> {
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                              "Feedback from administrator : ${widget.list != null && widget.index != null && widget.index! < widget.list!.length ? widget.list![widget.index!]['Feedback'] ?? 'Null' : 'Null'}",
                              style: TextStyle(fontSize: 18.0)),
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            value: widget.list != null && widget.index != null && widget.index! < widget.list!.length
                                ? widget.list![widget.index!]['CaseStatus']
                                : 'INREQ',
  ...
  Future<void> sendDataToServer() async {
    Map<String, dynamic> postData = {
      'CaseID': widget.list != null && widget.index != null && widget.index! < widget.list!.length
          ? widget.list![widget.index!]['CaseID'].toString()
          : '',
      'Feedback': descriptionController.text,
      'AdminID': widget.list![widget.index!]['AdminID'],
